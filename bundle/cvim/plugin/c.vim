...
let g:C_Version= "5.19"  							" version number of this script; do not change
"
"#################################################################################
"
...
"
	...
	exe "amenu  <silent>  ".s:MenuRun.'.executable\ to\ run<Tab>\\rme                     :call C_ExeToRun()<CR>'
	exe "imenu  <silent>  ".s:MenuRun.'.executable\ to\ run<Tab>\\rme                <C-C>:call C_ExeToRun()<CR>'
